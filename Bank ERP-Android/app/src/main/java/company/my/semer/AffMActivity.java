...
public class AffMActivity extends ListActivity {
    private ProgressDialog pDialog;

    // URL to get contacts JSON
    private static String url = "http://192.168.1.2:18080/ProjetBanque-web/rest/comptm";
...
//    private static final String TAG_PHONE_MOBILE = "ville";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aff_m);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(AffMActivity.this);
