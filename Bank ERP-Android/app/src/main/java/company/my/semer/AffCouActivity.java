...
public class AffCouActivity extends ListActivity {

    private ProgressDialog pDialog;

    // URL to get contacts JSON
    private static String url = "http://192.168.1.2:18080/ProjetBanque-web/rest/comptc";

    // JSON Node names

    private static final String TAG_ID = "RIB";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aff_cou);
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(AffCouActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    AffCouActivity.this, contactList,
